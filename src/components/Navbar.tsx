      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
        <div className="flex justify-between items-center h-12">
          ...
          <div className="hidden lg:flex items-center space-x-0.5">
            {navLinks.map(link => <Link key={link.path} to={link.path} className="px-2 py-1.5 font-medium text-foreground hover:text-primary transition-colors whitespace-nowrap text-base font-sans">
                {link.name}
              </Link>)}
          </div>
